    ...
    AlertDialog(
        ...
        icon = {
            Icon(
                ...
                contentDescription = stringResource(id = R.string.pick_work_goal),
                tint = MaterialTheme.colorScheme.primary,
            )
        },
        title = {
            TextView(
                text = stringResource(id = R.string.pick_work_goal),
...
private fun saveAndClose(
    ...
    if (valid) {
        ...
        if (goal > 0) {
            sharedPreferences.saveWorkGoal(goal)
...
@Preview
@Composable
fun ConfigurationsTabWorkGoalPreview() {
    ConfigurationsTabWorkGoalDialog {}
}
